...
jest.setTimeout(1200000); // at top of file
...
//     console.log("token for admin is for test 2: ", token);
...
//       {
//         avatarId: "123123123748374878423472389472374982374",
//       },
//       {
//         headers: {
//           authorization: `Bearer ${token}`,
...
//       `${BACKEND_URL}/api/v1/admin/element`,
//       {
//         imageUrl: "https://dummy.com/e1.png",
//         width: 1,
//         height: 1,
//         static: true,
//       },
...
//       `${BACKEND_URL}/api/v1/admin/element`,
//       {
//         imageUrl: "https://dummy.com/e2.png",
//         width: 1,
//         height: 1,
//         static: true,
//       },
...
//     // Create a map with default elements
//     const mapResponse = await axios.post(
//       `${BACKEND_URL}/api/v1/admin/map`,
//       {
//         thumbnail: "https://thumbnail.com/a.png",
...
//     try {
//       await axios.get(`${BACKEND_URL}/api/v1/space/wrongid`, {
//         headers: { authorization: `Bearer ${userToken}` },
//       });
//     } catch (err) {
...
//     expect(response.data.elements.length).toBe(3); // from defaultElements
//   });

//   // test("Delete endpoint deletes an element successfully", async () => {
//   //   const response = await axios.get(`${BACKEND_URL}/api/v1/space/${spaceId}`, {
//   //     headers: { authorization: `Bearer ${userToken}` },
//   //   });

//   //   const elementIdToDelete = response.data.elements[0].id;
...
//   //   expect(newResponse.data.elements.length).toBe(2); // should drop from 3 → 2
//   // });

//   test("Adding an element fails if it lies outside dimensions", async () => {
//     try {
//       await axios.post(
...
//   //   expect(newResponse.data.elements.length).toBe(3); // after delete (2) + add (1) = 3
//   // });
// });
...
//       },
//     );
//     expect(elementReponse.status).toBe(201);
...
//     expect(updateElementResponse.status).toBe(201);
//   });
// });
